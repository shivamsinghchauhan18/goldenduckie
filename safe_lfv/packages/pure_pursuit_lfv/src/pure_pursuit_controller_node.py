...
class pure_pursuit(object):
    def __init__(self):
        ...
        self.red_line_distance = self.setupParam('~red_line_distance', 0.2)  # added
        self.turn_omega = self.setupParam('~turn_omega', -2.0)  # s 12
        self.turn_duration = self.setupParam('~turn_duration', 1.0)  #s 13
        ...
        self.detection_list = []
        self.red_line_visible = False  # red
        self.red_line_last_seen = None  # red
        self.turn_in_progress = False  # turn
        self.turn_start_time = None  # turn
